    ...
    useEffect(() => {
        ...
        if(locationPathName.split('/')[1] == 'home'){
            if(whichPage == 'J'){
                ...
                cleanValsNum(linkBarVal[0], englishNums, -1, 1000000)
                cleanValsNum(linkBarVal[1], englishNums, -1, 1000000)
                cleanValsNum(linkBarVal[2], englishNums, -1, 7)
                cleanValsNum(linkBarVal[3], englishNums, 1329, 1406)
                cleanValsText(linkBarVal[4], facesSymbols)
                cleanValsNum(linkBarVal[5], englishNums, 0, 4)
                cleanValsNum(linkBarVal[6], trueOrFalse)
                cleanValsNum(linkBarVal[7], trueOrFalse)
                cleanValsNum(linkBarVal[8], trueOrFalse)
                cleanValsNum(linkBarVal[9], trueOrFalse)
                cleanValsNum(linkBarVal[10], englishNums, 0, 100000000000000)
                return
            } else if(whichPage == 'Z'){
                arrayLength(linkBarVal, 12)
                cleanValsNum(linkBarVal[0], englishNums, -1, 1000000)
